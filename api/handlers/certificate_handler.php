...
function get_certificate_details(PDO $conn, $studentId, $courseId) {
    ...
    // --- INÍCIO MODIFICAÇÃO 1: Adiciona s.schoolCity e s.state ---
    $sql = " SELECT
                ...
                s.profilePicture, s.schoolCity, s.state, -- <<< ADICIONADO AQUI
...
function generate_certificate_pdf_and_hash($details, $completionDate, $overrideCargaHoraria = null) {
    ...
    // --- INÍCIO MODIFICAÇÃO 2: Usa schoolCity e state ---
    ...
    $replacements = [
        ...
        '{{cidade_escola}}' => $schoolCity,   // <<< NOVO PLACEHOLDER
        '{{estado_escola}}' => $schoolState,  // <<< NOVO PLACEHOLDER
