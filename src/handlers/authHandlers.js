...
export function handleLogout() {
    ...
    Object.assign(appState, {
        ...
        schoolProfile: appState.schoolProfile, // Mantém o perfil da escola
        systemSettings: null,
...
export async function handleResetPassword(event) {
    ...
    try {
        const result = await apiCall('resetPassword', { token, newPassword });
        alert(result.message || 'Senha redefinida com sucesso!');
        // Usa a função de navegação global
